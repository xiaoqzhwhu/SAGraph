...
# greedy
def greedy(g, config, budget, rounds=1, model='SI', beta=0.1):
...
def celf(g, config, budget, rounds=1, model='SI', beta=1): 
...
def celfpp(g, config, budget, rounds=1, model='SI', beta=0.1):
